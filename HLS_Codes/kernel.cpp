...
#pragma HLS PIPELINE II=1
	...
	case 1:
		...
		if ((max_pool && out_num_iter == 0) || (!max_pool && (in_num_iter + LAYER_IN_NUM_T >= LAYER_IN_NUM))){
			count++;
			maxpool_w2 <data_t0, OUT_H_T, OUT_W_T, POOL_LANE, 2, DATA_W0> (fifo_cin, fifo_cout, STRIDE, POOL_EN, LAYER_IN_NUM_T, LAYER_IN_H_T, LAYER_IN_W_T, layer_id, count);
		}
		break;
	}
