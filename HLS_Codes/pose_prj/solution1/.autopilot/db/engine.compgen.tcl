...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename config_r \
    op interface \
    ports { config_r_address0 { O 5 vector } config_r_ce0 { O 1 bit } config_r_d0 { O 32 vector } config_r_q0 { I 32 vector } config_r_we0 { O 1 bit } config_r_address1 { O 5 vector } config_r_ce1 { O 1 bit } config_r_d1 { O 32 vector } config_r_q1 { I 32 vector } config_r_we1 { O 1 bit } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { global_cin_V_offset { I 58 vector } global_cin_V_offset_ap_vld { I 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { global_weight_V_offset { I 58 vector } global_weight_V_offset_ap_vld { I 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { global_bias_V_offset { I 58 vector } global_bias_V_offset_ap_vld { I 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { global_cout_V_offset { I 58 vector } global_cout_V_offset_ap_vld { I 1 bit } } \
} "
}
