...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_fifo_cin_V_V \
    op interface \
    ports { fifo_cin_V_V_dout { I 256 vector } fifo_cin_V_V_empty_n { I 1 bit } fifo_cin_V_V_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { fifo_cout_V_V_din { O 256 vector } fifo_cout_V_V_full_n { I 1 bit } fifo_cout_V_V_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { fifo_gamma_conv_V_V_dout { I 256 vector } fifo_gamma_conv_V_V_empty_n { I 1 bit } fifo_gamma_conv_V_V_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { fifo_beta_conv_V_V_dout { I 256 vector } fifo_beta_conv_V_V_empty_n { I 1 bit } fifo_beta_conv_V_V_read { O 1 bit } } \
} "
}
