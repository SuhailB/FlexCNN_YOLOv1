...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_fifo_in_V_V \
    op interface \
    ports { fifo_in_V_V_dout { I 256 vector } fifo_in_V_V_empty_n { I 1 bit } fifo_in_V_V_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_fifo_out_V_V \
    op interface \
    ports { fifo_out_V_V_din { O 256 vector } fifo_out_V_V_full_n { I 1 bit } fifo_out_V_V_write { O 1 bit } } \
} "
}
