...
`timescale 1ps/1ps
module weight_load_weighlbW_ram # (

  // Common module parameters
  parameter integer                 MEMORY_SIZE        = 1179648,
...
endmodule : weight_load_weighlbW_ram
`timescale 1 ns / 1 ps
module weight_load_weighlbW(
    reset,
    clk,
    address0,
    ce0,
...
weight_load_weighlbW_ram weight_load_weighlbW_ram_U(
    .clka( clk ),
    .rsta( reset ),
    .addra( address0 ),
    .ena( ce0 ),
