...
module cout_write_cout_bWhU_ram # (

  // Common module parameters
  parameter integer                 MEMORY_SIZE        = 2076672,
...
endmodule : cout_write_cout_bWhU_ram
`timescale 1 ns / 1 ps
module cout_write_cout_bWhU(
    reset,
    clk,
    address0,
    ce0,
...
cout_write_cout_bWhU_ram cout_write_cout_bWhU_ram_U(
    .clka( clk ),
    .clkb( clk ),
    .rsta( reset ),
    .rstb( reset ),
