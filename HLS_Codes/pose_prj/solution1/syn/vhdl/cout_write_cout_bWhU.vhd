...
entity cout_write_cout_bWhU_ram is 
   generic(
  -- Common module parameters
       MEMORY_SIZE        : integer := 2076672;
...
architecture rtl of cout_write_cout_bWhU_ram is 
...
entity cout_write_cout_bWhU is
    generic (
...
architecture arch of cout_write_cout_bWhU is
    component cout_write_cout_bWhU_ram is
        port (
            clka : IN STD_LOGIC;
            clkb : IN STD_LOGIC;
            rsta : IN STD_LOGIC;
...
begin
    cout_write_cout_bWhU_ram_U :  component cout_write_cout_bWhU_ram
    port map (
        clka => clk,
        clkb => clk,
        rsta => reset,
