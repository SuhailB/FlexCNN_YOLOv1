...
// ==============================================================
#ifndef __top_kernel_mul_muudo__HH__
#define __top_kernel_mul_muudo__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(top_kernel_mul_muudo) {
    ...
    SC_CTOR(top_kernel_mul_muudo):  ACMP_mul_su_U ("ACMP_mul_su_U") {
