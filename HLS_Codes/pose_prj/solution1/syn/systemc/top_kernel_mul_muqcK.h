...
// ==============================================================
#ifndef __top_kernel_mul_muqcK__HH__
#define __top_kernel_mul_muqcK__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(top_kernel_mul_muqcK) {
    ...
    SC_CTOR(top_kernel_mul_muqcK):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
