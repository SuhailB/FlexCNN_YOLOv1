...
// ==============================================================
#ifndef __top_kernel_udiv_3Thq__HH__
#define __top_kernel_udiv_3Thq__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(top_kernel_udiv_3Thq) {
    ...
    SC_CTOR(top_kernel_udiv_3Thq):  ACMP_udiv_seq_U ("ACMP_udiv_seq_U") {
