...
// ==============================================================
#ifndef __top_kernel_mul_16dEe__HH__
#define __top_kernel_mul_16dEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(top_kernel_mul_16dEe) {
    ...
    SC_CTOR(top_kernel_mul_16dEe):  ACMP_mul_us_U ("ACMP_mul_us_U") {
