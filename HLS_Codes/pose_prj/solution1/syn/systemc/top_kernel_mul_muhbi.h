...
// ==============================================================
#ifndef __top_kernel_mul_muhbi__HH__
#define __top_kernel_mul_muhbi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(top_kernel_mul_muhbi) {
    ...
    SC_CTOR(top_kernel_mul_muhbi):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
