...
// ==============================================================
#ifndef __top_kernel_mul_16cud__HH__
#define __top_kernel_mul_16cud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(top_kernel_mul_16cud) {
    ...
    SC_CTOR(top_kernel_mul_16cud):  ACMP_mul_us_U ("ACMP_mul_us_U") {
