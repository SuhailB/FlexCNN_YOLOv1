...
// ==============================================================
#ifndef __top_kernel_mul_32eOg__HH__
#define __top_kernel_mul_32eOg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(top_kernel_mul_32eOg) {
    ...
    SC_CTOR(top_kernel_mul_32eOg):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
