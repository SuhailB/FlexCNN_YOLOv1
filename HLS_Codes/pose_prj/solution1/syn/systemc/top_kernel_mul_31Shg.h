...
// ==============================================================
#ifndef __top_kernel_mul_31Shg__HH__
#define __top_kernel_mul_31Shg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(top_kernel_mul_31Shg) {
    ...
    SC_CTOR(top_kernel_mul_31Shg):  ACMP_mul_us_U ("ACMP_mul_us_U") {
