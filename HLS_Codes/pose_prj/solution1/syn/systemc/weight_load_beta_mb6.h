...
// ==============================================================
#ifndef __weight_load_beta_mb6_H__
#define __weight_load_beta_mb6_H__
...
struct weight_load_beta_mb6_ram : public sc_core::sc_module {
...
sc_core::sc_signal<sc_lv<DataWidth> > q0_t1;
   SC_CTOR(weight_load_beta_mb6_ram) {
...
SC_MODULE(weight_load_beta_mb6) {
...
weight_load_beta_mb6_ram* meminst;


SC_CTOR(weight_load_beta_mb6) {
meminst = new weight_load_beta_mb6_ram("weight_load_beta_mb6_ram");
