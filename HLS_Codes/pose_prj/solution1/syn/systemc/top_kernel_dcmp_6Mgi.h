...
// ==============================================================
#ifndef __top_kernel_dcmp_6Mgi__HH__
#define __top_kernel_dcmp_6Mgi__HH__
#include "ACMP_dcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(top_kernel_dcmp_6Mgi) {
    ...
    SC_CTOR(top_kernel_dcmp_6Mgi):  ACMP_dcmp_U ("ACMP_dcmp_U") {
        ACMP_dcmp_U.clk(clk);
