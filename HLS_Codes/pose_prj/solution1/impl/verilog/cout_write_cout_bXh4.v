...
module cout_write_cout_bXh4_ram # (

  // Common module parameters
  parameter integer                 MEMORY_SIZE        = 3538944,
...
endmodule : cout_write_cout_bXh4_ram
`timescale 1 ns / 1 ps
module cout_write_cout_bXh4(
    reset,
    clk,
    address0,
    ce0,
...
cout_write_cout_bXh4_ram cout_write_cout_bXh4_ram_U(
    .clka( clk ),
    .clkb( clk ),
    .rsta( reset ),
    .rstb( reset ),
