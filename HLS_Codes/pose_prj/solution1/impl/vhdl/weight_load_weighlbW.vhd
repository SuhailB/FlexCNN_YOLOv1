...
entity weight_load_weighlbW_ram is 
   generic(
  -- Common module parameters
       MEMORY_SIZE        : integer := 1179648;
...
architecture rtl of weight_load_weighlbW_ram is 
...
entity weight_load_weighlbW is
    generic (
...
architecture arch of weight_load_weighlbW is
    component weight_load_weighlbW_ram is
        port (
            clka : IN STD_LOGIC;
            rsta : IN STD_LOGIC;
...
begin
    weight_load_weighlbW_ram_U :  component weight_load_weighlbW_ram
    port map (
        clka => clk,
        rsta => reset,
        addra => address0,
