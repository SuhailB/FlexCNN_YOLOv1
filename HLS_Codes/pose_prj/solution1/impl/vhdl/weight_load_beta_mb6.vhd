...
entity weight_load_beta_mb6_ram is 
   generic(
...
architecture rtl of weight_load_beta_mb6_ram is 
...
entity weight_load_beta_mb6 is
    generic (
...
architecture arch of weight_load_beta_mb6 is
    component weight_load_beta_mb6_ram is
        port (
            clka : IN STD_LOGIC;
            rsta : IN STD_LOGIC;
...
begin
    weight_load_beta_mb6_ram_U :  component weight_load_beta_mb6_ram
    port map (
        clka => clk,
        rsta => reset,
        addra => address0,
