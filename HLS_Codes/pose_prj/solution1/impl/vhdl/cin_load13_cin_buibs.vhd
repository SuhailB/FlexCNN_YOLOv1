...
architecture rtl of cin_load13_cin_buibs_ram is 
...
architecture arch of cin_load13_cin_buibs is
    component cin_load13_cin_buibs_ram is
        port (
            clka : IN STD_LOGIC;
            rsta : IN STD_LOGIC;
...
begin
    cin_load13_cin_buibs_ram_U :  component cin_load13_cin_buibs_ram
    port map (
        clka => clk,
        rsta => reset,
        addra => address0,
