...
entity cout_write_cout_bXh4_ram is 
   generic(
  -- Common module parameters
       MEMORY_SIZE        : integer := 3538944;
  ...
  -- Port B module parameters
       WRITE_DATA_WIDTH_B : integer := 512;
       READ_DATA_WIDTH_B  : integer := 512;
       BYTE_WRITE_WIDTH_B : integer := 512;
       ADDR_WIDTH_B       : integer := 13;
...
architecture rtl of cout_write_cout_bXh4_ram is 
...
entity cout_write_cout_bXh4 is
    generic (
...
architecture arch of cout_write_cout_bXh4 is
    component cout_write_cout_bXh4_ram is
        port (
            clka : IN STD_LOGIC;
            clkb : IN STD_LOGIC;
            rsta : IN STD_LOGIC;
...
begin
    cout_write_cout_bXh4_ram_U :  component cout_write_cout_bXh4_ram
    port map (
        clka => clk,
        clkb => clk,
        rsta => reset,
