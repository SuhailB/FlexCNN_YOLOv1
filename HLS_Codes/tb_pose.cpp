...
char project_path_tb[200] = PROJ_DIR;
...
void instInit(
  ...
  char* prj_path_c = project_path_tb;
  string prj_path = prj_path_c;
  string file_path = strcat(project_path_tb, "data/yolo.insts");//prj_path + "/auto_compile/inst_gen/network.insts";
