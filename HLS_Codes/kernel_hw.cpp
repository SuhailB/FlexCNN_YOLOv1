...
// Macros
#define U1_IN_NUM 1024
#define U1_OUT_NUM 1024
#define U1_IN_IMG_H 418
#define U1_IN_IMG_W 418
#define U1_OUT_IMG_H 416
#define U1_OUT_IMG_W 416
#define U1_K 3
#define U1_IN_NUM_T 64
#define U1_OUT_NUM_T 64
#define U1_IN_IMG_H_T 13
#define U1_IN_IMG_W_T 52
#define U1_OUT_IMG_H_T 13
#define U1_OUT_IMG_W_T 52
#define U1_LAYER_BATCH 2
#define U1_STRIDE 1
#define U1_DATA0_SIZE 178917376
#define U1_DATA0_SIZE_ALIGNED (cal_aligned_size(178917376, U1_DATA0_PACK_FACTOR))
#define U1_DATA1_SIZE 9437184
#define U1_DATA1_SIZE_ALIGNED (cal_aligned_size(9437184, U1_DATA1_PACK_FACTOR))
#define U1_DATA2_SIZE 177209344
#define U1_DATA2_SIZE_ALIGNED (cal_aligned_size(177209344, U1_DATA2_PACK_FACTOR))

#define U1_ROW_IL_FACTOR 8
#define U1_COL_IL_FACTOR 4
#define U1_SA_ROWS 8
#define U1_SA_COLS 13
#define U1_LOCAL_REG_NUM 416
#define U1_LOCAL_ACCUM_NUM 72
...
#define U1_DATA0_BUF_SIZE 5760
#define U1_DATA0_HEAD_BUF_SIZE 692224
#define U1_DATA1_BUF_SIZE 4608
#define U1_DATA1_HEAD_BUF_SIZE 589824
#define U1_DATA2_BUF_SIZE 3328
#define U1_DATA2_HEAD_BUF_SIZE 692224
...
#pragma HLS DATA_PACK variable=fifo_transfer_in0
  ...
  while(!done1){
    ...
    ap_uint<5> t0 = 0;
    ap_uint<3> t2 = 0;
    ap_uint<3> t2_bound = LAYER_IN_IMG_W_T / U1_SA_COLS / LAYER_STRIDE;
    bool done2 = 0;
    while(!done2){
#pragma HLS PIPELINE II=1
...
#pragma HLS PIPELINE II=1
    ...
    ap_uint<14> w_bound = LAYER_COL_IL_FACTOR * LAYER_STRIDE + LAYER_FILTER_S - 1;
    ap_uint<14> h_bound = LAYER_IN_IMG_H_T + LAYER_FILTER_S - 1;
    ...
    ap_uint<14> wide_index = buffer_ind_to_feed_to_sys_arr / U1_DATA0_FC_SIMD_FACTOR;
    ap_uint<14> wide_offset = buffer_ind_to_feed_to_sys_arr % U1_DATA0_FC_SIMD_FACTOR;
...
#pragma HLS PIPELINE II=1
    ...
    ap_uint<14> wide_index = buffer_ind_to_feed_to_sys_arr / U1_DATA1_FC_SIMD_FACTOR;
    ap_uint<14> wide_offset = buffer_ind_to_feed_to_sys_arr % U1_DATA1_FC_SIMD_FACTOR;
...
#pragma HLS INLINE off
  bool LAST_ENGINE = (engine_id == 13 / U1_DATA0_FC_SPLIT_FACTOR - 1);
  ...
  local_transfer_size = data0_buf_size * (13 / U1_DATA0_FC_SPLIT_FACTOR - engine_id) * U1_DATA0_FC_GROUP_FACTOR;
...
#pragma HLS INLINE off
  ...
  ap_uint<14> transfer_counter = 0;
  ap_uint<14> data1_buf_size;
  ap_uint<14> local_transfer_size;
  bool more_to_write_to_buffer = true;
  bool more_to_feed_to_sys_arr = false;
  bool more_to_forward = true;
  ap_uint<11> buffer_write_counter = 0;
...
#pragma HLS INLINE off
  ...
  bool LAST_ENGINE = (engine_id == 13 / U1_DATA2_FC_SPLIT_FACTOR - 1);
  ...
  while(!done){
#pragma HLS PIPELINE II=1
    ap_uint<17> local_buf_idx = h * LAYER_COL_IL_FACTOR * LAYER_OUT_NUM_T + (w % LAYER_COL_IL_FACTOR) * LAYER_OUT_NUM_T + oo * U1_DATA2_FC_SIMD_FACTOR;
...
#pragma HLS INLINE off
  ...
  bool more_to_collect_from_sys_arr = true;
  ap_uint<1> buffer_gs_id = 0;
  ap_uint<13> buffer_read_counter = 0;
  ap_uint<5> c0_counter = 0;
  ap_uint<4> c1_counter = 0;
  ap_uint<3> c2_counter = 0;
...
#pragma HLS PIPELINE II=1
    ap_uint<13> buffer_ind_to_collect_from_sys_arr = c0_counter * LAYER_COL_IL_FACTOR * U1_SA_ROWS * LAYER_ROW_IL_FACTOR + c2_counter * U1_SA_ROWS * LAYER_ROW_IL_FACTOR + ((U1_SA_ROWS - 1 - c3_counter) * LAYER_ROW_IL_FACTOR + c1_counter);
...
#pragma HLS INLINE off
  ...
  while(!done1){
    ...
    ap_uint<39> task_num = 0;
    ap_uint<12> la_counter = 0;
    ap_uint<10> local_reg_id = 0;
    bool done2 = 0;
    while(!done2){
#pragma HLS PIPELINE II=1
...
#pragma HLS INLINE off
  ...
  for (ap_uint<2> layer_iter = 0; layer_iter < LAYER_BATCH; layer_iter++){
    ...
    {
      for (ap_uint<10> local_reg_id = 0; local_reg_id < U1_LOCAL_REG_NUM; local_reg_id++){
#pragma HLS PIPELINE II=1
        if (local_reg_id < LAYER_LOCAL_REG_NUM){
